-- =====================================================================
-- 3_gold_layer / 04_load_fact_table.sql   (Microsoft SQL Server / T-SQL)
-- ---------------------------------------------------------------------
-- Populates gold.fact_listings from silver.master_dataset, resolving
-- each row's natural keys (country, city, room_type, host attributes,
-- day_type) into the surrogate keys generated by 03_load_dimensions.sql.
--
-- Run this LAST, after all dimension tables have been loaded.
-- =====================================================================
